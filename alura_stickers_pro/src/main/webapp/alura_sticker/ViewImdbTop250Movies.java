...
import br.com.alura_sticker.GeradorDeFigurinhas;
...
public class ViewImdbTop250Movies {
	...
	public static void showMovies() throws Exception {
		...
		for (ImdbTop250Item movie : listaImbdTop250) {
			  ...
			  GeradorDeFigurinhas.gerarFigurinha(new URL(movie.getImage()).openStream(), movie.getTitle(),Double.parseDouble(movie.getImDbRating()));
		}		
	}
